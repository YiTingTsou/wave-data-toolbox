function [dataset_metadata] = saveCompleteDataset(foldername, wind_data, location_info, start_year_month, end_year_month, additional_params, distance_km, verbose)
...
base_complete_filename = sprintf('%s/wind_data_%d_%d_%.4fE_%.4fN', ...
    foldername, start_year_month, end_year_month, location_info.actual_lon, location_info.actual_lat);
