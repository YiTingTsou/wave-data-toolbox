...
%SAVEMONTHLYDATA Save monthly wave data to file
%
...
%
% INPUTS:
%   monthly_data      - Structure containing monthly wave data
...
try
    ...
    table_data = {monthly_data.time, monthly_data.t02, monthly_data.hs, monthly_data.dir};
    var_names = {'time', 't02', 'hs', 'dir'};
